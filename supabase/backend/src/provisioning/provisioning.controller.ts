...
export class ProvisioningController {
  ...
  async startProvisioning(@Body() dto: CreateProvisioningDto): Promise<ProvisioningJobDto> {
  ...
  @Roles("admin", "super_admin", "viewer")
  async getStatus(@Param("accountId") accountId: string): Promise<ProvisioningStatusDto> {
  ...
  @Roles("admin", "super_admin")
  async deprovision(@Param("accountId") accountId: string): Promise<{ message: string }> {
