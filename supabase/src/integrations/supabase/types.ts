  ...
  public: {
    Tables: {
      ...
      build_executions: {
        ...
        Relationships: [
          {
            foreignKeyName: "build_executions_build_job_id_fkey"
      ...
      build_jobs: {
        ...
        Relationships: [
          {
            foreignKeyName: "build_jobs_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "build_jobs_enterprise_id_fkey"
            columns: ["enterprise_id"]
            isOneToOne: false
            referencedRelation: "enterprises"
            referencedColumns: ["id"]
      ...
      connector_workstreams: {
        ...
        Relationships: [
          {
            foreignKeyName: "connector_workstreams_connector_id_fkey"
          ...
          {
            foreignKeyName: "connector_workstreams_workstream_id_fkey"
      ...
      connectors: {
        ...
        Relationships: [
          {
            foreignKeyName: "connectors_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "connectors_credential_id_fkey"
          ...
          {
            foreignKeyName: "connectors_enterprise_id_fkey"
            columns: ["enterprise_id"]
            isOneToOne: false
            referencedRelation: "enterprises"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "connectors_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "connectors_service_id_fkey"
            columns: ["service_id"]
            isOneToOne: false
            referencedRelation: "services"
            referencedColumns: ["id"]
